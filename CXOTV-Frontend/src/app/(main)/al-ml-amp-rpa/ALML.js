    ...
    const fetchCXOTalkData = async (page = 1) => {
        try {
            ...
            const response = await fetch(
                `${BACKEND_URL}/api/news?populate=*&sort=publishedAt:DESC&filters[$or][0][categories].data[name][$eq]=Al%20Ml%20amp%20RPA&filters[$or][1][subcategories].data[name][$eq]=Al%20Ml%20amp%20RPA&pagination[page]=1`
            );
