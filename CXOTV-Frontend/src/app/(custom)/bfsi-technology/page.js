    ...
    const fetchCXOTalkData = async (page = 1) => {
        try {
            ...
            const response = await fetch(
                `${BACKEND_URL}/api/news?populate=*&sort=publishedAt:DESC&filters[$or][0][categories][name][$eq]=BFSI%20Technology&filters[$or][1][subcategories][name][$eq]=BFSI%20Technology&pagination[page]=${page}`
            );
