    ...
    const fetchCXOTalkData = async (page = 1) => {
        try {
            ...
            const response = await fetch(
                `${BACKEND_URL}/api/news?populate=*&sort=publishedAt:DESC&filters[$or][0][categories].data[name][$eq]=Healthcare%20IT%20News&filters[$or][1][subcategories].data[name][$eq]=Healthcare%20IT%20News&filters[$or][2][categories].data[name][$eq]=Health%20CxO%20Talk&filters[$or][3][subcategories].data[name][$eq]=Health%20CxO%20Talk&pagination[page]=1`
            );
